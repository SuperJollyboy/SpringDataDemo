...
import com.gl.springDataDemo.DataValidation.myValidator;
import com.gl.springDataDemo.constants.springDataDemoConstants;
import com.gl.springDataDemo.dto.User;
import com.gl.springDataDemo.exception.ApiRequestException;
...
public class UserController {
    ...
    springDataDemoConstants myConstants = new springDataDemoConstants();
    ...
    public User getUser(@PathVariable String id){
        ...
        //myval.validateUserId(id);
        
        if (id.contains("0")) {
        	
        	throw new ApiRequestException(myConstants.USER_FIELD_BLANK);
        }
